...
class banana():
    ...
    def update_R2(self,R2):
        if 2 >= R2 and R2 >1.7: return 0.21
        elif 1.7 >= R2 and R2 > 1.5: return (0.798-0.42* R2)/0.4
        elif 1.5 >= R2 and R2 > -1.4: return (2.676 - 0.16*R2)/5.8
        elif -1.4 >= R2 and R2 >= -sqrt(3): return (-7/25 +sqrt(3) +0.8 *R2)/(sqrt(3)-1.4)/2
